...
def remove_pun_ch(text):
	return re.sub(u"[%s]"%punctuation , "", text)
...
if __name__ == '__main__':
    ...
    content_fp = root_path + '/corpus.txt'
    title_fp = root_path + '/corpus_title.txt'
    ...
    for index,content,title in zip(indexs,data_content,data_title):
        data_content[index] = remove_tag(content)
        data_title[index] = remove_tag(title)
